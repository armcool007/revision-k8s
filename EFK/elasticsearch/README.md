...
```
cd existing_repo
git remote add origin https://gitlab.com/testgp6121442/k8stesting.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/testgp6121442/k8stesting/-/settings/integrations)
